...
const accessToken =
  "MC5aSTNldEJVQUFDb0FCNFFt.dSHvv71CND8t77-977-977-9Mzp377-9fjTvv73vv73vv73vv73vv73vv73vv71G77-977-9GO-_ve-_vWrvv718";
...
//news carousel
newsNextBtn.onclick = () => {
  newsCardSection.scrollLeft += 400;
};
newsPrevBtn.onclick = () => {
  newsCardSection.scrollLeft -= 400;
};
